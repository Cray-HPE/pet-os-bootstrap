...
openstack server create  --flavor highcpu.4  --key-name craystack --user-data init.sh  --volume $rebuild_node --network Cray_Network --network PET_NET --file /etc/hosts=hosts $rebuild_node
